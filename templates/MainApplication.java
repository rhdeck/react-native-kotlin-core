...
import com.rnk.core.RNKPackage;
...
public class MainApplication extends Application implements ReactApplication {
  ...
  private final ReactNativeHost mReactNativeHost =
      new ReactNativeHost(this) {
        ...
        protected String getJSBundleFile() {
            RNKRegistry.instance.trigger("host.getBundleFile");
            String newBundle = (String) RNKRegistry.getInstance().get("jsBundleFile");
            if(newBundle == null) {
  ...
  public void onCreate() {
      ...
      List<ReactPackage> packages = new PackageList(this, null).getPackages();
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.rnktest8.ReactNativeFlipper");
        aClass
